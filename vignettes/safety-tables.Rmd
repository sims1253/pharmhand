...
`create_ae_summary_table()` makes safety tables for treatment-emergent adverse events (TEAEs).

## Quick Safety Report

Generate a complete safety report in one call:

```{r quick-safety, eval=FALSE}
...
- Overview of TEAEs, related AEs, SAEs, discontinuations
- AEs by System Organ Class
- Serious Adverse Events
- Formatted Word document with proper styling
...
> **Note**: `create_ae_summary_table(type = "comparison")` is a convenience wrapper around `create_ae_comparison_table()`. Both functions produce identical results—use whichever entry point you prefer.
...
- [Creating Efficacy Tables](https://sims1253.github.io/pharmhand/articles/efficacy-tables.html)
