...
|-------------------------------------------------|-----|------|-----|--------|------|------|----------|-------------|--------------------|-------|-------|-----|----------------------------------|------------------------|---------|
| TRT01P                                          | n   | mean | sd  | median | min  | max  | variable | layer_type  | Pooled Age Group 1 | N_tot | pct   | Sex | Race                             | Ethnicity              | Country |
...
| Subject Disposition |         |                      |                     |                |
|---------------------|---------|----------------------|---------------------|----------------|
| End of Study Status | Placebo | Xanomeline High Dose | Xanomeline Low Dose | Screen Failure |
