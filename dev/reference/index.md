...
- [`ConfigurationRegistry()`](https://sims1253.github.io/pharmhand/dev/reference/ConfigurationRegistry.md)
  : ConfigurationRegistry Class
- [`PTConfig()`](https://sims1253.github.io/pharmhand/dev/reference/PTConfig.md)
  : PTConfig Class
- [`PopulationConfig()`](https://sims1253.github.io/pharmhand/dev/reference/PopulationConfig.md)
  : PopulationConfig Class
- [`SOCConfig()`](https://sims1253.github.io/pharmhand/dev/reference/SOCConfig.md)
  : SOCConfig Class
- [`SubgroupConfig()`](https://sims1253.github.io/pharmhand/dev/reference/SubgroupConfig.md)
  : SubgroupConfig Class
- [`config_api`](https://sims1253.github.io/pharmhand/dev/reference/config_api.md)
  : Configuration API for Clinical Reports
- [`config_classes`](https://sims1253.github.io/pharmhand/dev/reference/config_classes.md)
  : S7 Configuration Classes for Clinical Reports
- [`define_population_config()`](https://sims1253.github.io/pharmhand/dev/reference/define_population_config.md)
  : Define or override a population configuration
- [`define_subgroup_config()`](https://sims1253.github.io/pharmhand/dev/reference/define_subgroup_config.md)
  : Define or override a subgroup configuration
- [`get_performance_setting()`](https://sims1253.github.io/pharmhand/dev/reference/get_performance_setting.md)
  : Get performance setting
- [`get_population_config()`](https://sims1253.github.io/pharmhand/dev/reference/get_population_config.md)
  : Get population configuration
- [`get_subgroup_config()`](https://sims1253.github.io/pharmhand/dev/reference/get_subgroup_config.md)
  : Get subgroup configuration
- [`list_populations()`](https://sims1253.github.io/pharmhand/dev/reference/list_populations.md)
  : List available populations
- [`list_subgroups()`](https://sims1253.github.io/pharmhand/dev/reference/list_subgroups.md)
  : List available subgroups
- [`load_config()`](https://sims1253.github.io/pharmhand/dev/reference/load_config.md)
  : Load configuration from YAML file
- [`update_pt_config()`](https://sims1253.github.io/pharmhand/dev/reference/update_pt_config.md)
  : Update PT configuration
- [`update_soc_config()`](https://sims1253.github.io/pharmhand/dev/reference/update_soc_config.md)
...
- [`test_non_inferiority()`](https://sims1253.github.io/pharmhand/dev/reference/test_non_inferiority.md)
...
- [`ancova_adjust_continuous()`](https://sims1253.github.io/pharmhand/dev/reference/ancova_adjust_continuous.md)
...
- [`create_ae_exposure_table()`](https://sims1253.github.io/pharmhand/dev/reference/create_ae_exposure_table.md)
...
- [`create_time_to_first_ae()`](https://sims1253.github.io/pharmhand/dev/reference/create_time_to_first_ae.md)
...
- [`calculate_exposure_adjusted_rate()`](https://sims1253.github.io/pharmhand/dev/reference/calculate_exposure_adjusted_rate.md)
...
- [`create_ae_cumulative_incidence_plot()`](https://sims1253.github.io/pharmhand/dev/reference/create_ae_cumulative_incidence_plot.md)
...
- [`create_loglog_plot()`](https://sims1253.github.io/pharmhand/dev/reference/create_loglog_plot.md)
...
- [`clinical_table_from_results()`](https://sims1253.github.io/pharmhand/dev/reference/clinical_table_from_results.md)
...
- [`MCIDResult()`](https://sims1253.github.io/pharmhand/dev/reference/MCIDResult.md)
  : MCIDResult Class
...
- [`bias_adjusted_meta()`](https://sims1253.github.io/pharmhand/dev/reference/bias_adjusted_meta.md)
  : Bias-Adjusted Meta-Analysis
- [`rob_sensitivity_analysis()`](https://sims1253.github.io/pharmhand/dev/reference/rob_sensitivity_analysis.md)
  : Sensitivity Analysis Across Risk of Bias Scenarios
- [`calculate_rob_weights()`](https://sims1253.github.io/pharmhand/dev/reference/calculate_rob_weights.md)
...
- [`NMAResult()`](https://sims1253.github.io/pharmhand/dev/reference/NMAResult.md)
  : NMAResult Class
...
- [`RoB2Result()`](https://sims1253.github.io/pharmhand/dev/reference/RoB2Result.md)
  : RoB2Result S7 Class
- [`assess_rob2()`](https://sims1253.github.io/pharmhand/dev/reference/assess_rob2.md)
  : Assess Risk of Bias using RoB 2
- [`assess_rob2_batch()`](https://sims1253.github.io/pharmhand/dev/reference/assess_rob2_batch.md)
  : Assess Multiple Studies with RoB 2
- [`rob2_summary()`](https://sims1253.github.io/pharmhand/dev/reference/rob2_summary.md)
  : Create Summary Table of RoB 2 Assessments
- [`ROBINSIResult()`](https://sims1253.github.io/pharmhand/dev/reference/ROBINSIResult.md)
  : ROBINSIResult S7 Class
- [`assess_robins_i()`](https://sims1253.github.io/pharmhand/dev/reference/assess_robins_i.md)
  : Assess Risk of Bias using ROBINS-I
- [`assess_robins_i_batch()`](https://sims1253.github.io/pharmhand/dev/reference/assess_robins_i_batch.md)
  : Assess Multiple Studies with ROBINS-I
- [`robins_i_summary()`](https://sims1253.github.io/pharmhand/dev/reference/robins_i_summary.md)
  : Create Summary Table of ROBINS-I Assessments
- [`robins_i_plot()`](https://sims1253.github.io/pharmhand/dev/reference/robins_i_plot.md)
  : Create ROBINS-I Summary Plot
- [`robins_i_to_df()`](https://sims1253.github.io/pharmhand/dev/reference/robins_i_to_df.md)
  : Export ROBINS-I Assessment to Data Frame
- [`create_rob_traffic_light_plot()`](https://sims1253.github.io/pharmhand/dev/reference/create_rob_traffic_light_plot.md)
  : Create Traffic Light Plot for Risk of Bias
- [`create_rob_summary_plot()`](https://sims1253.github.io/pharmhand/dev/reference/create_rob_summary_plot.md)
  : Create Summary Plot for Risk of Bias
- [`save_rob_plot()`](https://sims1253.github.io/pharmhand/dev/reference/save_rob_plot.md)
  : Save Risk of Bias Plot
- [`rob_data_to_tidy()`](https://sims1253.github.io/pharmhand/dev/reference/rob_data_to_tidy.md)
...
- [`grade_evidence()`](https://sims1253.github.io/pharmhand/dev/reference/grade_evidence.md)
  : Grade Evidence According to IQWiG Criteria
- [`assess_evidence_domains()`](https://sims1253.github.io/pharmhand/dev/reference/assess_evidence_domains.md)
  : Assess Individual IQWiG Evidence Domains
- [`format_evidence_grade()`](https://sims1253.github.io/pharmhand/dev/reference/format_evidence_grade.md)
  : Format Evidence Grade for Display
- [`evidence_summary_table()`](https://sims1253.github.io/pharmhand/dev/reference/evidence_summary_table.md)
...
- [`export_evidence_table()`](https://sims1253.github.io/pharmhand/dev/reference/export_evidence_table.md)
  : Export Evidence Table
- [`create_rob_summary_table()`](https://sims1253.github.io/pharmhand/dev/reference/create_rob_summary_table.md)
  : Create Risk of Bias Summary Table
- [`evidence_narrative`](https://sims1253.github.io/pharmhand/dev/reference/evidence_narrative.md)
  : Evidence Narrative Generation
- [`generate_evidence_narrative()`](https://sims1253.github.io/pharmhand/dev/reference/generate_evidence_narrative.md)
  : Generate Evidence Narrative
- [`generate_endpoint_narrative()`](https://sims1253.github.io/pharmhand/dev/reference/generate_endpoint_narrative.md)
  : Generate Endpoint-Specific Narrative
- [`generate_batch_narratives()`](https://sims1253.github.io/pharmhand/dev/reference/generate_batch_narratives.md)
  : Generate Batch Narratives
- [`generate_full_evidence_report()`](https://sims1253.github.io/pharmhand/dev/reference/generate_full_evidence_report.md)
  : Generate Full Evidence Report
- [`export_narrative()`](https://sims1253.github.io/pharmhand/dev/reference/export_narrative.md)
  : Export Narrative to Text File
- [`narrative_template()`](https://sims1253.github.io/pharmhand/dev/reference/narrative_template.md)
  : Narrative Template
...
- [`BalanceAssessment()`](https://sims1253.github.io/pharmhand/dev/reference/BalanceAssessment.md)
...
- [`calculate_smd()`](https://sims1253.github.io/pharmhand/dev/reference/calculate_smd.md)
  : Calculate Standardized Mean Difference for Continuous Variables
- [`calculate_smd_binary()`](https://sims1253.github.io/pharmhand/dev/reference/calculate_smd_binary.md)
  : Calculate Standardized Mean Difference for Binary Variables
- [`calculate_smd_from_data()`](https://sims1253.github.io/pharmhand/dev/reference/calculate_smd_from_data.md)
  : Calculate SMD Directly from Data
- [`adjust_pvalues()`](https://sims1253.github.io/pharmhand/dev/reference/adjust_pvalues.md)
...
- [`get_locale()`](https://sims1253.github.io/pharmhand/dev/reference/get_locale.md)
  : Get the Current Locale
- [`tr()`](https://sims1253.github.io/pharmhand/dev/reference/tr.md) :
  Translate a Key to the Current Locale
- [`tr_col()`](https://sims1253.github.io/pharmhand/dev/reference/tr_col.md)
...
- [`list_translation_keys()`](https://sims1253.github.io/pharmhand/dev/reference/list_translation_keys.md)
  : List Available Translation Keys
- [`reset_custom_translations()`](https://sims1253.github.io/pharmhand/dev/reference/reset_custom_translations.md)
...
- [`detect_floor_ceiling()`](https://sims1253.github.io/pharmhand/dev/reference/detect_floor_ceiling.md)
  : Detect Floor and Ceiling Effects
- [`test_ph_assumption()`](https://sims1253.github.io/pharmhand/dev/reference/test_ph_assumption.md)
...
- [`study_logic`](https://sims1253.github.io/pharmhand/dev/reference/study_logic.md)
  : Study Logic
- [`efficacy_primary`](https://sims1253.github.io/pharmhand/dev/reference/efficacy_primary.md)
  : Primary Endpoint Tables
- [`efficacy_cfb`](https://sims1253.github.io/pharmhand/dev/reference/efficacy_cfb.md)
  : Change from Baseline Tables
- [`efficacy_lab`](https://sims1253.github.io/pharmhand/dev/reference/efficacy_lab.md)
  : Lab Summary Tables
- [`efficacy_tte`](https://sims1253.github.io/pharmhand/dev/reference/efficacy_tte.md)
  : Time-to-Event Tables
- [`efficacy_responder`](https://sims1253.github.io/pharmhand/dev/reference/efficacy_responder.md)
  : Responder Analysis Tables
- [`efficacy_subgroup`](https://sims1253.github.io/pharmhand/dev/reference/efficacy_subgroup.md)
  : Subgroup Analysis Tables
- [`safety_summary`](https://sims1253.github.io/pharmhand/dev/reference/safety_summary.md)
  : Adverse Event Summary Tables
- [`safety_tte`](https://sims1253.github.io/pharmhand/dev/reference/safety_tte.md)
  : Adverse Event Time-to-Event Analysis
- [`safety_comparison`](https://sims1253.github.io/pharmhand/dev/reference/safety_comparison.md)
  : Adverse Event Comparison Tables
- [`safety_exposure`](https://sims1253.github.io/pharmhand/dev/reference/safety_exposure.md)
  : Exposure-Adjusted AE Analysis
- [`safety_hierarchy`](https://sims1253.github.io/pharmhand/dev/reference/safety_hierarchy.md)
...
- [`plotting_common`](https://sims1253.github.io/pharmhand/dev/reference/plotting_common.md)
  : Plotting Common Utilities
- [`plotting_survival`](https://sims1253.github.io/pharmhand/dev/reference/plotting_survival.md)
  : Survival Analysis Plots
- [`plotting_efficacy`](https://sims1253.github.io/pharmhand/dev/reference/plotting_efficacy.md)
  : Efficacy Visualization Plots
- [`plotting_forest`](https://sims1253.github.io/pharmhand/dev/reference/plotting_forest.md)
  : Forest Plots for Subgroup Analysis
- [`meta_core`](https://sims1253.github.io/pharmhand/dev/reference/meta_core.md)
  : Meta-Analysis Core Functions
- [`meta_plots`](https://sims1253.github.io/pharmhand/dev/reference/meta_plots.md)
  : Meta-Analysis Visualization Functions
- [`meta_indirect`](https://sims1253.github.io/pharmhand/dev/reference/meta_indirect.md)
  : Indirect Comparison Functions
- [`meta_network`](https://sims1253.github.io/pharmhand/dev/reference/meta_network.md)
  : Network Meta-Analysis Functions
- [`meta_bayesian`](https://sims1253.github.io/pharmhand/dev/reference/meta_bayesian.md)
  : Bayesian Meta-Analysis Functions
- [`bias_rob2`](https://sims1253.github.io/pharmhand/dev/reference/bias_rob2.md)
  : Risk of Bias 2 (RoB 2) Assessment for RCTs
- [`bias_robins_i`](https://sims1253.github.io/pharmhand/dev/reference/bias_robins_i.md)
  : ROBINS-I (Risk Of Bias In Non-randomized Studies - of Interventions)
- [`bias_plots`](https://sims1253.github.io/pharmhand/dev/reference/bias_plots.md)
  : Risk of Bias Visualization Functions
- [`meta_bias`](https://sims1253.github.io/pharmhand/dev/reference/meta_bias.md)
  : Publication Bias Assessment Functions
- [`meta_bias_adjusted`](https://sims1253.github.io/pharmhand/dev/reference/meta_bias_adjusted.md)
  : Bias-Adjusted Meta-Analysis Functions
- [`pro_analysis`](https://sims1253.github.io/pharmhand/dev/reference/pro_analysis.md)
  : PRO Analysis Functions
- [`evidence_grading`](https://sims1253.github.io/pharmhand/dev/reference/evidence_grading.md)
