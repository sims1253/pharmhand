...
# The table automatically creates a flextable
...
table_obj <- ClinicalTable(
  data = data.frame(Var = c("A", "B"), Value = c("1.2", "3.4")),
  flextable = flextable::flextable(data.frame(Var = c("A", "B"), Value = c("1.2", "3.4"))),
  type = "simple"
)
