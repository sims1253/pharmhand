...
#> 
#> $interpretation
#> [1] "NNH = 12.5 (95% CI: 7.1 to 50). Treat 12 patients for one additional patient to be harmed."
#> 
...
#> 
#> $interpretation
#> [1] "Effect not statistically significant (CI crosses zero). Point estimate NNT = 20 to benefit"
#> 
```
