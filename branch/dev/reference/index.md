...
- [`extract_chef_metadata()`](https://sims1253.github.io/pharmhand/branch/dev/reference/extract_chef_metadata.md)
  : Extract Metadata from Chef Output
- [`flatten_chef_results()`](https://sims1253.github.io/pharmhand/branch/dev/reference/flatten_chef_results.md)
