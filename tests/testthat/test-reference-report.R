...
describe("reference-report", {
	it("LayeredTable demographics works with pharmaverseadam", {
	...
	it("Demographics section has expected structure", {
		skip_if_not_installed("pharmaverseadam")
	...
	it("AE summary by SOC has expected structure", {
		skip_if_not_installed("pharmaverseadam")
	...
	it("ClinicalReport assembles correctly", {
		skip_if_not_installed("pharmaverseadam")
	...
	it("create_clinical_table with HTA theme applies correct styling", {
	...
	it("apply_clinical_style works with different presets", {
		skip_if_not_installed("flextable")
	...
	it("HTASection with content works", {
		skip_if_not_installed("pharmaverseadam")
	...
	it("SOCPTSection works correctly", {
	...
	it("layered_to_flextable produces valid output", {
		skip_if_not_installed("flextable")
	...
	it("Reference report is generated as docx", {
		skip_if_not_installed("pharmaverseadam")
