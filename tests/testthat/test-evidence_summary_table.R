...
describe("evidence summary table", {
	it("create_evidence_summary_table works with basic input", {
		endpoints <- list(
	...
	it("create_evidence_summary_table formats effect estimate correctly", {
		endpoints <- list(
			OS = list(
				result = MetaResult(
					estimate = 0.75,
	...
	it("create_evidence_summary_table formats I2 heterogeneity", {
		endpoints <- list(
			OS = list(
				result = MetaResult(
					estimate = 0.75,
	...
	it("create_evidence_summary_table handles missing I2", {
		endpoints <- list(
			OS = list(
	...
	it("create_evidence_summary_table formats p-values correctly", {
		endpoints <- list(
			OS = list(
				result = MetaResult(
					estimate = 0.75,
	...
	it("create_evidence_summary_table works with English output", {
		endpoints <- list(
			OS = list(
				result = MetaResult(
					estimate = 0.75,
	...
	it("create_evidence_summary_table works with German output", {
		endpoints <- list(
			OS = list(
				result = MetaResult(
					estimate = 0.75,
	...
	it("create_evidence_summary_table uses German decimal separator", {
		endpoints <- list(
			OS = list(
				result = MetaResult(
					estimate = 0.75,
	...
	it("create_evidence_summary_table respects column selection", {
		endpoints <- list(
			OS = list(
				result = MetaResult(
					estimate = 0.75,
	...
	it("create_evidence_summary_table warns on missing columns", {
		endpoints <- list(
			OS = list(
				result = MetaResult(
					estimate = 0.75,
	...
	it("create_evidence_summary_table rejects empty list", {
		expect_error(
	...
	it("create_evidence_summary_table rejects non-list input", {
		expect_error(
	...
	it("create_evidence_summary_table rejects missing result", {
		endpoints <- list(
			OS = list(
				grade = EvidenceGrade(
					grade = "indication",
	...
	it("create_study_characteristics_table works with TwoArmStudy objects", {
		studies <- list(
			TwoArmStudy(
				study_id = "STUDY001",
	...
	it("create_study_characteristics_table works with data frame input", {
		studies <- list(
			data.frame(
				study_id = "STUDY001",
				design = "rct",
	...
	it("create_study_characteristics_table works with list input", {
		studies <- list(
			list(
				study_id = "STUDY001",
				design = "rct",
	...
	it("create_study_characteristics_table formats design labels", {
		studies <- list(
			list(
				study_id = "S1",
				design = "rct",
	...
	it("create_study_characteristics_table handles SingleArmStudy", {
		studies <- list(
			SingleArmStudy(
				study_id = "STUDY001",
	...
	it("create_study_characteristics_table rejects invalid study type", {
	...
	it("create_study_characteristics_table warns on missing columns", {
		studies <- list(
	...
	it("export_evidence_table works with Word format", {
		withr::with_tempdir({
			endpoints <- list(
				OS = list(
					result = MetaResult(
	...
	it("export_evidence_table works with HTML format", {
		withr::with_tempdir({
			endpoints <- list(
				OS = list(
					result = MetaResult(
	...
	it("export_evidence_table works with Excel format", {
	...
	it("export_evidence_table rejects unsupported format", {
		endpoints <- list(
			OS = list(
				result = MetaResult(
					estimate = 0.75,
	...
	it("export_evidence_table rejects non-ClinicalTable", {
		expect_error(
	...
	it("export_evidence_table uses title parameter", {
		withr::with_tempdir({
			endpoints <- list(
				OS = list(
					result = MetaResult(
	...
	it("create_rob_summary_table works with RoB2Result objects", {
		rob_results <- list(
	...
	it("create_rob_summary_table includes justification when requested", {
		rob_results <- list(
			assess_rob2("Study 1", "Low", "Low", "Low", "Low", "Low")
		)
	...
	it("create_rob_summary_table rejects non-RoB2Result objects", {
		expect_error(
	...
	it("create_rob_summary_table rejects empty list", {
		expect_error(
	...
	it("Full workflow: create, export evidence summary table", {
		withr::with_tempdir({
			endpoints <- list(
				OS = list(
					result = MetaResult(
	...
	it("Full workflow: create study characteristics table", {
		withr::with_tempdir({
			studies <- list(
				TwoArmStudy(
					study_id = "STUDY001",
