...
test_that("to_gba_template formats ClinicalTable", {
...
test_that("to_gba_template formats ClinicalReport tables", {
	df <- data.frame(Statistic = "n", Value = 10)
	table <- ClinicalTable(data = df, flextable = NULL, type = "test")
...
test_that("to_gba_template handles list input", {
	df <- data.frame(Statistic = "n", Value = 10)
	table <- ClinicalTable(data = df, flextable = NULL, type = "test")
...
test_that("to_gba_template validates input", {
	expect_error(
