...
describe("efficacy responder", {
	it("create_responder_table works with basic data", {
	...
	it("create_responder_table handles extreme response rates with RR", {
	...
	it("create_responder_table supports different CI methods", {
		adrs <- create_mock_responder_data(n = 40)
	...
	it("create_responder_table works with ADaMData", {
	...
	it("create_responder_table handles OR comparison", {
		adrs <- create_mock_responder_data(n = 40)
	...
	it("create_responder_table handles RR comparison", {
		adrs <- create_mock_responder_data(n = 40)
	...
	it("create_responder_table handles RD comparison", {
		adrs <- create_mock_responder_data(n = 40)
	...
	it("create_responder_table wilson CI method works", {
		adrs <- create_mock_responder_data(n = 40)
	...
	it("create_responder_table exact CI method works", {
		adrs <- create_mock_responder_data(n = 40)
	...
	it("create_responder_table wald CI method works", {
		adrs <- create_mock_responder_data(n = 40)
	...
	it("create_responder_table handles very small sample size", {
	...
	it("create_responder_table handles single arm", {
	...
	it("create_responder_table handles multiple non-reference arms", {
	...
	it("create_responder_table handles NA response values", {
		adrs <- data.frame(
	...
	it("create_responder_table uses custom ref_group", {
		adrs <- create_mock_responder_data(n = 40)
