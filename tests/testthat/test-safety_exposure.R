...
describe("safety exposure", {
	it("calculate_exposure_adjusted_rate: normal case", {
	...
	it("calculate_exposure_adjusted_rate: zero events", {
		result <- calculate_exposure_adjusted_rate(
			n_events = 0,
			patient_years = 5,
			conf_level = 0.95,
	...
	it("calculate_exposure_adjusted_rate: small patient_years warning", {
	...
	it("calculate_exposure_adjusted_rate: invalid n_events", {
	...
	it("calculate_exposure_adjusted_rate: invalid patient_years", {
	...
	it("calculate_exposure_adjusted_rate: invalid conf_level", {
		expect_error(
			calculate_exposure_adjusted_rate(
				n_events = 5,
				patient_years = 5,
	...
	it("calculate_exposure_adjusted_rate: invalid per parameter", {
		expect_error(
			calculate_exposure_adjusted_rate(
				n_events = 5,
				patient_years = 5,
	...
	it("calculate_exposure_adjusted_rate: different per values", {
	...
	it("calculate_exposure_adjusted_rate: different confidence levels", {
	...
	it("create_ae_exposure_table: by = 'pt' (preferred term)", {
		set.seed(123)
	...
	it("create_ae_exposure_table: by = 'soc' (system organ class)", {
		set.seed(123)
		adsl <- get_shared_adsl(n = 10)
	...
	it("create_ae_exposure_table: by = 'overall'", {
		set.seed(123)
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: time_unit options", {
		set.seed(123)
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: threshold filters results", {
		set.seed(123)
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: missing AEDECOD column when by = 'pt'", {
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: missing AEBODSYS column when by = 'soc'", {
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: missing TRTDURD column in adsl", {
		adsl <- get_shared_adsl(n = 10)
		# Don't add TRTDURD
	...
	it("create_ae_exposure_table: missing TRTEMFL column", {
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: no TEAEs returns empty table", {
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: invalid by parameter", {
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: invalid time_unit parameter", {
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: invalid per parameter", {
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: invalid threshold parameter", {
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: negative exposure values error", {
		adsl <- get_shared_adsl(n = 10)
	...
	it("create_ae_exposure_table: custom per value", {
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: custom conf_level", {
		set.seed(123)
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table returns correct ClinicalTable", {
		set.seed(123)
		adsl <- get_shared_adsl(n = 10)
		adsl$TRTDURD <- round(runif(10, 30, 365), 1)
	...
	it("create_ae_exposure_table: NA exposure values warn and exclude", {
		adsl <- get_shared_adsl(n = 10)
