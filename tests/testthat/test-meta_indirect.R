...
describe("meta indirect", {
	it("indirect_comparison calculates Bucher estimate", {
	...
	it("indirect_comparison handles different effect measures", {
		# HR
	...
	it("indirect_comparison validates standard errors", {
		expect_error(
			indirect_comparison(
				effect_ab = log(0.75),
	...
	it("compare_direct_indirect tests consistency", {
	...
	it("assess_transitivity evaluates population balance", {
	...
	it("assess_transitivity handles categorical characteristics", {
	...
	it("assess_transitivity handles insufficient variation", {
	...
	it("assess_transitivity validates inputs", {
