...
describe("bias robins i", {
	it("ROBINSIResult can be created with all required properties", {
	...
	it("ROBINSIResult rejects missing domain", {
		expect_error(
			ROBINSIResult(
				study_id = "OBS001",
				domains = list(
	...
	it("ROBINSIResult rejects domain without judgment", {
		expect_error(
			ROBINSIResult(
				study_id = "OBS001",
				domains = list(
	...
	it("ROBINSIResult rejects invalid domain judgment", {
		expect_error(
			ROBINSIResult(
				study_id = "OBS001",
				domains = list(
	...
	it("ROBINSIResult rejects invalid overall judgment", {
		expect_error(
			ROBINSIResult(
				study_id = "OBS001",
				domains = list(
	...
	it("ROBINSIResult has correct default values", {
		result <- ROBINSIResult(
			study_id = "OBS001",
			domains = list(
	...
	it("ROBINSIResult summary_df computed property works", {
		result <- ROBINSIResult(
			study_id = "OBS001",
			domains = list(
	...
	it("ROBINSIResult judgment_counts computed property works", {
		result <- ROBINSIResult(
			study_id = "OBS001",
			domains = list(
				D1_confounding = list(judgment = "Low"),
	...
	it("ROBINSIResult worst_domain computed property returns most severe", {
	...
	it("assess_robins_i creates valid result with all Low judgments", {
	...
	it("assess_robins_i auto-calculates overall as Critical", {
		result <- assess_robins_i(
			study_id = "OBS001",
	...
	it("assess_robins_i auto-calculates overall as Serious", {
	...
	it("assess_robins_i auto-calculates overall as Moderate", {
	...
	it("assess_robins_i auto-calculates overall as No information with
           any No information", {
		result <- assess_robins_i(
			study_id = "OBS001",
	...
	it("assess_robins_i auto-calculates overall correctly for mixed
           scenarios", {
	...
	it("assess_robins_i accepts custom overall judgment", {
		result <- assess_robins_i(
			study_id = "OBS001",
			d1_confounding = "Low",
			d2_selection = "Low",
	...
	it("assess_robins_i accepts optional outcome and intervention
           parameters", {
		result <- assess_robins_i(
			study_id = "OBS001",
			d1_confounding = "Low",
	...
	it("assess_robins_i accepts optional support text", {
		result <- assess_robins_i(
			study_id = "OBS001",
			d1_confounding = "Serious",
			d2_selection = "Low",
	...
	it("assess_robins_i accepts optional metadata", {
		result <- assess_robins_i(
			study_id = "OBS001",
			d1_confounding = "Low",
			d2_selection = "Low",
	...
	it("assess_robins_i rejects missing study_id", {
		expect_error(
			assess_robins_i(
				study_id = NULL,
				d1_confounding = "Low",
	...
	it("assess_robins_i rejects invalid domain judgment", {
		expect_error(
			assess_robins_i(
				study_id = "OBS001",
	...
	it("assess_robins_i rejects NULL domain judgment", {
		expect_error(
			assess_robins_i(
				study_id = "OBS001",
				d1_confounding = NULL,
	...
	it("assess_robins_i rejects empty string domain judgment", {
		expect_error(
			assess_robins_i(
				study_id = "OBS001",
				d1_confounding = "",
	...
	it(".calculate_robins_i_overall returns Low for all Low judgments", {
		judgments <- rep("Low", 7)
		expect_equal(.calculate_robins_i_overall(judgments), "Low")
	})

	it(".calculate_robins_i_overall returns Critical for any Critical
           judgment", {
		# One Critical
	...
	it(".calculate_robins_i_overall returns Serious for any Serious
           (no Critical)", {
		# One Serious
	...
	it(".calculate_robins_i_overall returns Moderate for any Moderate
           (no Serious/Critical)", {
		# One Moderate
	...
	it(".calculate_robins_i_overall returns No information for any
           No information", {
		judgments <- c("No information", "Low", "Low", "Low", "Low", "Low", "Low")
		expect_equal(.calculate_robins_i_overall(judgments), "No information")
	})

	it(".calculate_robins_i_overall rejects wrong length input", {
		expect_error(
	...
	it(".generate_robins_i_justification returns correct text for Low", {
		judgments <- rep("Low", 7)
		just <- .generate_robins_i_justification(judgments, "Low")
		expect_equal(just, "All domains rated Low risk of bias")
	})

	it(".generate_robins_i_justification returns correct text for
           Critical", {
	...
	it(".generate_robins_i_justification returns correct text for Critical
           with multiple", {
	...
	it(".generate_robins_i_justification returns correct text for Serious", {
	...
	it(".generate_robins_i_justification returns correct text for No
           information", {
		judgments <- c("No information", "Low", "Low", "Low", "Low", "Low", "Low")
	...
	it("assess_robins_i_batch processes single study data frame", {
		data <- data.frame(
			study_id = "OBS001",
			d1_confounding = "Low",
			d2_selection = "Low",
	...
	it("assess_robins_i_batch processes multiple studies", {
		data <- data.frame(
	...
	it("assess_robins_i_batch includes optional columns", {
		data <- data.frame(
			study_id = "OBS001",
			d1_confounding = "Serious",
			d2_selection = "Low",
	...
	it("assess_robins_i_batch accepts custom overall judgments", {
		data <- data.frame(
			study_id = "OBS001",
			d1_confounding = "Low",
			d2_selection = "Low",
	...
	it("assess_robins_i_batch handles missing optional columns gracefully", {
		data <- data.frame(
			study_id = "OBS001",
			d1_confounding = "Low",
			d2_selection = "Low",
	...
	it("assess_robins_i_batch rejects data frame without study_id column", {
	...
	it("assess_robins_i_batch rejects data frame without required domain
           columns", {
	...
	it("assess_robins_i_batch rejects non-data-frame input", {
		expect_error(
	...
	it("robins_i_summary creates data frame from single result", {
		results <- list(
			assess_robins_i(
				study_id = "OBS001",
				d1_confounding = "Low",
	...
	it("robins_i_summary creates data frame from multiple results", {
		results <- list(
			assess_robins_i(
				study_id = "OBS001",
				d1_confounding = "Low",
	...
	it("robins_i_summary includes justification when requested", {
		results <- list(
			assess_robins_i(
				study_id = "OBS001",
				d1_confounding = "Critical",
	...
	it("robins_i_summary returns empty data frame for empty list", {
	...
	it("robins_i_summary rejects non-list input", {
		expect_error(
	...
	it("robins_i_summary rejects list with non-ROBINSIResult elements", {
		results <- list(
			assess_robins_i(
				study_id = "OBS001",
				d1_confounding = "Low",
	...
	it("ROBINSIResult print method works", {
		result <- assess_robins_i(
			study_id = "OBS001",
			d1_confounding = "Low",
			d2_selection = "Low",
	...
	it("All five judgments are valid for all domains", {
	...
	it("assess_robins_i handles NA in optional parameters", {
		data <- data.frame(
			study_id = "OBS001",
			d1_confounding = "Low",
			d2_selection = "Low",
	...
	it("assess_robins_i handles character study_id correctly", {
		result <- assess_robins_i(
	...
	it("domains list contains all required domain names", {
		result <- ROBINSIResult(
			study_id = "TEST",
			domains = list(
				D1_confounding = list(judgment = "Low"),
	...
	it("Empty support text is handled correctly", {
		result <- assess_robins_i(
			study_id = "OBS001",
			d1_confounding = "Low",
			d2_selection = "Low",
	...
	it("Complete workflow with summary works end-to-end", {
	...
	it("ROBINS-I algorithm prioritizes correctly across all judgment
           levels", {
	...
	it("domains are in correct order in summary", {
		result <- assess_robins_i(
			study_id = "OBS001",
			d1_confounding = "Serious",
			d2_selection = "Low",
	...
	it("robins_i_summary preserves row names from results list", {
		results <- list(
	...
	it("Justification generation works for all judgment levels", {
