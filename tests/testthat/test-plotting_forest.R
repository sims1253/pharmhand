...
describe("plotting forest", {
	it("create_forest_plot works with TTE data", {
	...
	it("create_forest_plot works with binary data", {
		skip_if_not_installed("ggplot2")
	...
	it("create_forest_plot includes overall estimate", {
		skip_if_not_installed("survival")
		skip_if_not_installed("ggplot2")
	...
	it("create_forest_plot calculates interaction p-values", {
		skip_if_not_installed("survival")
		skip_if_not_installed("ggplot2")
	...
	it("create_forest_plot warns for missing subgroup variables", {
		skip_if_not_installed("survival")
		skip_if_not_installed("ggplot2")
	...
	it("create_forest_plot respects log_scale parameter", {
		skip_if_not_installed("survival")
		skip_if_not_installed("ggplot2")
	...
	it("create_forest_plot works with ADaMData", {
		skip_if_not_installed("survival")
		skip_if_not_installed("ggplot2")
