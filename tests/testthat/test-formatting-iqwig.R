...
describe("formatting-iqwig", {
	it("format_pvalue formats correctly with default locale (en)", {
	...
	it("format_pvalue respects German locale", {
	...
	it("format_pvalue handles custom digits and threshold", {
		# Custom digits
	...
	it("format_ci respects German locale", {
		expect_equal(format_ci(0.85, 1.23, locale = "de"), "[0,85; 1,23]")
	})

	it("format_ci handles custom digits and brackets", {
		# Custom digits
	...
	it("format_ci validates input lengths", {
		expect_error(
	...
	it("format_number handles locale correctly", {
		# English (default)
	...
	it("format_percentage formats correctly", {
		# Basic percentage
