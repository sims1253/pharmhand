...
describe("efficacy tte", {
	it("create_tte_summary_table works with basic data", {
	...
	it("create_tte_summary_table with landmarks", {
		skip_if_not_installed("survival")
	...
	it("create_tte_summary_table works with ADaMData", {
		skip_if_not_installed("survival")
	...
	it("create_tte_summary_table includes HR for two-arm studies", {
		skip_if_not_installed("survival")
	...
	it("create_tte_summary_table warns on PH violations", {
		skip_if_not_installed("survival")
	...
	it("create_tte_summary_table check_ph can suppress warnings", {
		skip_if_not_installed("survival")
	...
	it("test_ph_assumption flags PH violations", {
		skip_if_not_installed("survival")
	...
	it("test_ph_assumption handles proportional hazards data", {
		skip_if_not_installed("survival")
	...
	it("test_ph_assumption accepts coxph model input", {
		skip_if_not_installed("survival")
	...
	it("test_ph_assumption can generate Schoenfeld plots", {
		skip_if_not_installed("survival")
