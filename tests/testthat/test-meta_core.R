...
describe("meta core", {
	...
	it("meta_analysis returns MetaResult for fixed-effect model", {
		yi <- .meta_yi_hr
		sei <- .meta_sei_hr
	...
	it("meta_analysis sets correct model for fixed-effect", {
		yi <- .meta_yi_hr
		sei <- .meta_sei_hr
	...
	it("meta_analysis sets correct effect measure", {
		yi <- .meta_yi_hr
		sei <- .meta_sei_hr
	...
	it("meta_analysis records number of studies", {
		yi <- .meta_yi_hr
		sei <- .meta_sei_hr
	...
	it("meta_analysis produces positive estimate for HR", {
		yi <- .meta_yi_hr
		sei <- .meta_sei_hr
	...
	it("meta_analysis produces confidence interval", {
		yi <- .meta_yi_hr
		sei <- .meta_sei_hr
	...
	it("meta_analysis returns MetaResult for random-effects model", {
		yi <- .meta_yi_hr
		sei <- .meta_sei_hr
	...
	it("meta_analysis sets correct model for random-effects", {
		yi <- .meta_yi_hr
		sei <- .meta_sei_hr
	...
	it("meta_analysis calculates tau2 for random-effects", {
		yi <- .meta_yi_hr
		sei <- .meta_sei_hr
	...
	it("meta_analysis calculates I2 for random-effects", {
		yi <- .meta_yi_hr
		sei <- .meta_sei_hr
	...
	it("meta_analysis calculates Q statistic", {
	...
	it("meta_analysis calculates I2 statistic", {
		yi <- .meta_yi_md # Variable effects
		sei <- .meta_sei_md
	...
	it("meta_analysis calculates tau2 statistic", {
		yi <- .meta_yi_md # Variable effects
		sei <- .meta_sei_md
	...
	it("meta_analysis errors with insufficient studies", {
		yi <- c(0.5)
		sei <- c(0.1)
	...
	it("meta_analysis errors with mismatched lengths", {
		yi <- c(0.5, 0.6)
		sei <- c(0.1)
	...
	it("meta_analysis errors with missing yi", {
		expect_error(
	...
	it("meta_analysis errors with missing sei", {
		expect_error(
	...
	it("meta_analysis accepts data frame input", {
		df <- data.frame(
	...
	it("meta_analysis calculates prediction intervals for random effects", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("meta_analysis warns when prediction interval df is very low (k=3)", {
		yi <- c(0.2, 1.0, 0.0)
		sei <- c(0.1, 0.1, 0.1)
	...
	it("meta_analysis works with HR effect measure", {
		yi <- .meta_yi_or
		sei <- .meta_sei_or
	...
	it("meta_analysis works with OR effect measure", {
		yi <- .meta_yi_or
		sei <- .meta_sei_or
	...
	it("meta_analysis works with RR effect measure", {
		yi <- .meta_yi_or
		sei <- .meta_sei_or
	...
	it("meta_analysis works with RD effect measure", {
		yi <- .meta_yi_or
		sei <- .meta_sei_or
	...
	it("meta_analysis works with MD effect measure", {
		yi <- .meta_yi_or
		sei <- .meta_sei_or
	...
	it("meta_analysis uses DL method", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("meta_analysis uses REML method", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("meta_analysis uses PM method", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("meta_analysis applies Knapp-Hartung adjustment", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("meta_analysis omits Knapp-Hartung adjustment when FALSE", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("meta_analysis stores individual study results", {
		yi <- .meta_yi_hr_small
	...
	it("meta_analysis stores study results as ComparisonResult", {
		yi <- .meta_yi_hr_small
		sei <- .meta_sei_hr_small
	...
	it("meta_analysis labels study results correctly", {
		yi <- .meta_yi_hr_small
		sei <- .meta_sei_hr_small
		...
		expect_equal(
			names(result@study_results),
			c("Study 1", "Study 2", "Study 3")
		)
	})

	it("meta_analysis stores study weights", {
		yi <- .meta_yi_hr_small
		sei <- .meta_sei_hr_small
	...
	it("meta_analysis has positive study weights", {
		yi <- .meta_yi_hr_small
		sei <- .meta_sei_hr_small
	...
	it("meta_analysis study weights sum to 1", {
		yi <- .meta_yi_hr_small
		sei <- .meta_sei_hr_small
	...
	it("calculate_heterogeneity returns Q statistic", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("calculate_heterogeneity returns I2 statistic", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("calculate_heterogeneity returns tau2 statistic", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("calculate_heterogeneity returns interpretation", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("calculate_heterogeneity supports DL method", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("calculate_heterogeneity supports REML method", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("calculate_heterogeneity supports PM method", {
		yi <- .meta_yi_md
		sei <- .meta_sei_md
	...
	it("leave_one_out performs sensitivity analysis", {
		yi <- .meta_yi_hr
		sei <- .meta_sei_hr
	...
	it("leave_one_out identifies influential studies", {
	...
	it("leave_one_out works with direct yi/sei input", {
		yi <- c(0.5, 0.6, 0.4)
		sei <- c(0.1, 0.1, 0.1)
