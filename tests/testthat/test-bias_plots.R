...
describe("bias plots", {
	it("create_rob_traffic_light_plot works with single RoB2Result", {
	...
	it("create_rob_traffic_light_plot works with multiple RoB2Result", {
		results <- list(
	...
	it("create_rob_traffic_light_plot respects show_overall = FALSE", {
		results <- list(
	...
	it("create_rob_traffic_light_plot accepts custom title", {
	...
	it("create_rob_traffic_light_plot accepts custom colors", {
		result <- create_rob2_result("STUDY001")
	...
	it("create_rob_traffic_light_plot accepts base_size", {
		result <- create_rob2_result("STUDY001")
	...
	it("create_rob_traffic_light_plot calculates correct dimensions", {
		results <- list(
			create_rob2_result("STUDY001"),
			create_rob2_result("STUDY002"),
	...
	it("create_rob_traffic_light_plot works with single ROBINSIResult", {
	...
	it("create_rob_traffic_light_plot works with multiple ROBINSIResult", {
		results <- list(
	...
	it("create_rob_traffic_light_plot handles all ROBINS-I judgments", {
		results <- list(
	...
	it("create_rob_summary_plot works with RoB2Result list", {
		results <- list(
			create_rob2_result("STUDY001", d4 = "Some concerns"),
			create_rob2_result("STUDY002", d3 = "High"),
	...
	it("create_rob_summary_plot works with ROBINSIResult list", {
		results <- list(
			create_robinsi_result("OBS001", d1 = "Serious"),
			create_robinsi_result("OBS002", d6 = "Critical"),
			create_robinsi_result("OBS003", d3 = "Moderate")
	...
	it("create_rob_summary_plot accepts custom title", {
	...
	it("create_rob_summary_plot respects horizontal = FALSE", {
		results <- list(
			create_rob2_result("STUDY001"),
			create_rob2_result("STUDY002")
		)
	...
	it("create_rob_summary_plot accepts custom colors", {
		results <- list(create_rob2_result("STUDY001"))
	...
	it("create_rob_summary_plot accepts base_size", {
		results <- list(create_rob2_result("STUDY001"))
	...
	it("create_rob_summary_plot calculates correct proportions", {
		results <- list(
	...
	it("save_rob_plot saves PNG file", {
		result <- create_rob2_result("STUDY001")
		plot <- create_rob_traffic_light_plot(list(result))
	...
	it("save_rob_plot saves PDF file", {
		result <- create_rob2_result("STUDY001")
		plot <- create_rob_traffic_light_plot(list(result))
	...
	it("save_rob_plot saves SVG file", {
	...
	it("save_rob_plot accepts custom dimensions", {
		result <- create_rob2_result("STUDY001")
		plot <- create_rob_traffic_light_plot(list(result))
	...
	it("save_rob_plot accepts custom DPI", {
		result <- create_rob2_result("STUDY001")
		plot <- create_rob_traffic_light_plot(list(result))
	...
	it("save_rob_plot works with ggplot", {
		result <- create_rob2_result("STUDY001")
		plot <- create_rob_traffic_light_plot(list(result))
	...
	it("save_rob_plot returns filename", {
		result <- create_rob2_result("STUDY001")
		plot <- create_rob_traffic_light_plot(list(result))
	...
	it("rob_data_to_tidy returns long format by default for RoB2", {
		results <- list(
	...
	it("rob_data_to_tidy returns wide format for RoB2", {
		results <- list(
			create_rob2_result("STUDY001", d4 = "Some concerns")
		)
	...
	it("rob_data_to_tidy handles multiple RoB2 results", {
		results <- list(
			create_rob2_result("STUDY001", d4 = "Some concerns"),
			create_rob2_result("STUDY002", d3 = "High")
		)
	...
	it("rob_data_to_tidy returns long format by default for ROBINS-I", {
		results <- list(
	...
	it("rob_data_to_tidy returns wide format for ROBINS-I", {
		results <- list(
			create_robinsi_result(
				"OBS001",
				d1 = "Serious",
	...
	it("rob_data_to_tidy handles multiple ROBINS-I results", {
		results <- list(
			create_robinsi_result("OBS001", d1 = "Serious"),
			create_robinsi_result("OBS002", d6 = "Critical"),
			create_robinsi_result("OBS003", d3 = "Moderate")
	...
	it("create_rob_traffic_light_plot rejects empty list", {
		expect_error(
	...
	it("create_rob_traffic_light_plot rejects non-list input", {
		expect_error(
	...
	it("create_rob_traffic_light_plot rejects mixed RoB2/ROBINS-I results", {
		results <- list(
			create_rob2_result("STUDY001"),
	...
	it("create_rob_traffic_light_plot rejects invalid result objects", {
		results <- list(
	...
	it("create_rob_summary_plot rejects empty list", {
		expect_error(
	...
	it("create_rob_summary_plot rejects non-list input", {
		expect_error(
	...
	it("create_rob_summary_plot rejects mixed RoB2/ROBINS-I results", {
		results <- list(
			create_rob2_result("STUDY001"),
			create_robinsi_result("OBS001")
		)
	...
	it("save_rob_plot rejects missing filename", {
		result <- create_rob2_result("STUDY001")
		plot <- create_rob_traffic_light_plot(list(result))
	...
	it("save_rob_plot rejects empty filename", {
		result <- create_rob2_result("STUDY001")
		plot <- create_rob_traffic_light_plot(list(result))
	...
	it("save_rob_plot rejects invalid plot type", {
		expect_error(
	...
	it("save_rob_plot rejects invalid width", {
		result <- create_rob2_result("STUDY001")
		plot <- create_rob_traffic_light_plot(list(result))
	...
	it("save_rob_plot rejects invalid height", {
		result <- create_rob2_result("STUDY001")
		plot <- create_rob_traffic_light_plot(list(result))
	...
	it("save_rob_plot rejects invalid DPI", {
		result <- create_rob2_result("STUDY001")
		plot <- create_rob_traffic_light_plot(list(result))
	...
	it("rob_data_to_tidy rejects empty list", {
		expect_error(
	...
	it("rob_data_to_tidy rejects non-list input", {
		expect_error(
	...
	it("rob_data_to_tidy rejects mixed RoB2/ROBINS-I results", {
		results <- list(
			create_rob2_result("STUDY001"),
			create_robinsi_result("OBS001")
		)
	...
	it("rob_data_to_tidy handles empty list correctly", {
		expect_error(
			rob_data_to_tidy(list()),
			"results must be a non-empty list"
		)
	...
	it("Complete workflow: assess -> plot -> save -> tidy", {
		results <- list(
			create_rob2_result("STUDY001", d4 = "Some concerns", outcome = "OS"),
	...
	it("Complete ROBINS-I workflow: assess -> plot -> save -> tidy", {
		results <- list(
			create_robinsi_result(
				"OBS001",
				d1 = "Serious",
