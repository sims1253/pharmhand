...
describe("meta bias", {
	it("eggers_test detects asymmetry", {
	...
	it("eggers_test returns NA for insufficient studies", {
		yi <- c(0.5)
		sei <- c(0.2)
	...
	it("eggers_test can accept MetaResult input", {
	...
	it("trim_and_fill detects and imputes missing studies", {
	...
	it("trim_and_fill supports different estimators", {
		yi <- c(-0.5, -0.4, -0.3, -0.1, 0.0, 0.5, 0.6, 0.7)
		sei <- c(0.1, 0.12, 0.15, 0.18, 0.2, 0.1, 0.12, 0.15)
	...
	it("create_funnel_plot creates ClinicalPlot", {
	...
	it("create_funnel_plot supports customization", {
		yi <- log(c(0.75, 0.82, 0.68, 0.91, 0.77))
		sei <- c(0.12, 0.15, 0.18, 0.14, 0.11)
	...
	it("create_funnel_plot default title is used when not specified", {
		yi <- log(c(0.75, 0.82, 0.68, 0.91, 0.77))
		sei <- c(0.12, 0.15, 0.18, 0.14, 0.11)
