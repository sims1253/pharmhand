...
describe("meta plots", {
	it("create_meta_forest_plot creates ClinicalPlot", {
	...
	it("create_meta_forest_plot supports customization", {
		yi <- log(c(0.75, 0.82, 0.68))
		sei <- c(0.12, 0.15, 0.18)
	...
	it("create_meta_forest_plot shows elements when enabled", {
		yi <- log(c(0.75, 0.82, 0.68))
		sei <- c(0.12, 0.15, 0.18)
