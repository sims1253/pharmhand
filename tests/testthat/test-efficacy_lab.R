...
describe("efficacy lab", {
	it("create_lab_summary_table returns ClinicalTable", {
	...
	it("create_lab_summary_table has correct type", {
		adlb <- fixture_adlb_lab_summary()
	...
	it("create_lab_shift_table returns ClinicalTable", {
	...
	it("create_lab_shift_table has correct type", {
		adlb <- fixture_adlb_lab_shift()
	...
	it("create_lab_shift_table has expected columns", {
		adlb <- fixture_adlb_lab_shift()
	...
	it("create_lab_shift_table errors on NULL input", {
		expect_error(
	...
	it("create_lab_summary_table errors on NULL input", {
		expect_error(
	...
	it("create_lab_summary_table errors when required columns missing", {
		expect_error(
